      ...
      <div className="w-full max-w-md">
        ...
        >
          <div className="mb-6">
            ...
            >
              Join thousands of students automating their homework
            </p>
          </div>
          ...
          <form className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                I agree to the{' '}
                <Link href="#" className="underline" style={{ color: 'var(--accent-primary)' }}>
                  Terms of Service
                </Link>
              </span>
            </div>
        ...
        <p
          ...
          style={{ color: 'var(--text-secondary)' }}
        >
          By signing up, you agree that you understand the risks and{' '}
